...
class df_success:
    ...
    def generate(self):
        ...
        <body>
            <h1>Successfull Application Report </h1> <h3><a href="https://github.com/rakshitha2207/internshala_automation">by Internshala_bot</a></h3>
            {html_table}
        </body>
        </html>
        """
...
class df_failed():
    ...
    def generate(self):
        ...
        html_template = f"""
            ...
            <body>
               <h1>Failed to Apply Report </h1> <h3><a href="https://github.com/rakshitha2207/internshala_automation"> by Internshala_bot </a></h3>
                {html_table}
            </body>
            </html>
